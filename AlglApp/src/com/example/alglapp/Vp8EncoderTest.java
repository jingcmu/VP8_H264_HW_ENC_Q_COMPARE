 ...
 */
public class Vp8EncoderTest extends Vp8CodecTestBaseCts {
    ...
    //private static final int[] TEST_BITRATES_SET = { 900000 };
    //private static final int[] TEST_BITRATES_SET = { 300000 };
    ...
    public void testAsyncEncoding() throws Exception {
        ...
        Log.d(TAG, "testAsyncEncoding PASSED");
    }
    ...
    public void testSyncFrame() throws Exception {
        ...
        Log.d(TAG, "testSyncFrame PASSED");
    }
    ...
    public void testDynamicBitrateChange() throws Exception {
     ...
     public void testParallelEncodingAndDecoding() throws Exception {
         ...
         int encodeSeconds = 9;
         Log.d(TAG, "---------- testParallelEncodingAndDecoding------------");
         ...
         Log.d(TAG, "testParallelEncodingAndDecoding PASSED");
     }
